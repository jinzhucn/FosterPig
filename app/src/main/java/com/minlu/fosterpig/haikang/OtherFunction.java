...
//        HCNetSDK.getInstance().NET_DVR_PlayBackControl_V50(nHandle, PlaybackControlCommand.NET_DVR_PLAY_CONVERT, compression, null);
	...
	public static void Test_SaveRealData(int iPreviewID)
	{
	    if(!HCNetSDK.getInstance().NET_DVR_SaveRealData(iPreviewID, "/sdcard/test.mp4"))
	    {
	    ...
	    if(!HCNetSDK.getInstance().NET_DVR_StopSaveRealData(iPreviewID))
	    {
